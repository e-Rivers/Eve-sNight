...
local logout = require('components.logout')
...
-- Directly open appclication keybindings {{{
awful.keyboard.append_global_keybindings({
   ...
   awful.key({ SUPER }, "f",
    ...
    awful.key({ SUPER }, "i",
        function()
            awful.spawn(apps.terminal.." bpytop")
        end,
...
awful.keyboard.append_global_keybindings({
   ...
   awful.key({SUPER, SHIFT}, 'p', function()
